...
def benchmark(request, pk):
    ...
    context = {'flat':flat, 'flats':flats, 'flatcount':flatcount, 'mean':mean, 'flatEPI':flatEPI, 'flatPOC':flatPOC, 'allflatsincat':allflatsincat, 'percEPI': percEPI, 'percPOC': percPOC}    
